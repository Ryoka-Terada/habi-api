...
class PaymentSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    DB::table('payment')->insert(['payment_id' => '5', 'parent_id' => '', 'child_id' => '', 'payment_date' => new DateTime('2023-02-25 00:00:00'), 'amount' => 1000, 'user_id' => '1', 'is_pay' => 1, 'created_at' => new DateTime(), 'updated_at' => new DateTime()]);
    DB::table('payment')->insert(['payment_id' => '6', 'parent_id' => '', 'child_id' => '', 'payment_date' => new DateTime('2023-02-25 00:00:00'), 'amount' => 1000, 'user_id' => '1', 'is_pay' => 0, 'created_at' => new DateTime(), 'updated_at' => new DateTime()]);
